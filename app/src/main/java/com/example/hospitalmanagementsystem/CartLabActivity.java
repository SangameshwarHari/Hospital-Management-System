...
public class CartLabActivity extends AppCompatActivity {
    ...
    Button btncheckCart,btnBack,timebutton,datebutton;
    ListView lst;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timebutton=findViewById(R.id.buttonaapptime);
        btncheckCart=findViewById(R.id.checkoutbutton);
        btnBack=findViewById(R.id.cartback);
        tvTotal=findViewById(R.id.textviewdtotalcostttt);
